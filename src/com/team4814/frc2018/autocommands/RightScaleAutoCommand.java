 ...
 *
 */
public class RightScaleAutoCommand extends CommandGroup
{

	public RightScaleAutoCommand()
	{
		...
		if (goLeft)
			addSequential(new RightScaleLAutoCommand());
		else
			addSequential(new RightScaleRAutoCommand());
	}
}
