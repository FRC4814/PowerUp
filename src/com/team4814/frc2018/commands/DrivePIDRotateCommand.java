 ...
 *
 */
public class DrivePIDRotateCommand extends Command
{
	...
	public DrivePIDRotateCommand(double targetSetpoint)
	{
		this(targetSetpoint, 0.4);
	}

	public DrivePIDRotateCommand(double targetSetpoint, double speed)
	{
	...
	protected void execute()
	{
		...
		//			currentSetpoint = currentSetpoint + speed * 0.5;
		//		else
